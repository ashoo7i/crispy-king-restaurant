...
async function main() {
  ...
  await prisma.customizationOption.createMany({
    data: [
      ...
      { menuItemId: item1.id, name: 'حجم كبير (مع بطاطس ومشروب ضخم)', price: 8.0, category: 'SIZE' },
      { menuItemId: item1.id, name: 'جبنة شيدر إضافية', price: 2.0, category: 'ADDON' },
      { menuItemId: item1.id, name: 'صوص رانش إضافي', price: 1.5, category: 'ADDON' },
  ...
  await prisma.customizationOption.createMany({
    data: [
      ...
      { menuItemId: item2.id, name: 'إضافة صوص الثوم', price: 2.0, category: 'ADDON' },
    ],
  });
  ...
  await prisma.customizationOption.createMany({
    data: [
      ...
      { menuItemId: item3.id, name: 'حجم كبير مكس', price: 8.0, category: 'SIZE' },
      { menuItemId: item3.id, name: 'شريحة لحم إضافية', price: 9.0, category: 'ADDON' },
      { menuItemId: item3.id, name: 'جبنة إضافية', price: 2.0, category: 'ADDON' },
    ],
  });
  ...
  await prisma.customizationOption.createMany({
    data: [
      ...
      { menuItemId: item4.id, name: 'حجم كبير جداً', price: 3.0, category: 'SIZE' },
      { menuItemId: item4.id, name: 'إضافة بهارات حارة', price: 1.0, category: 'ADDON' },
      { menuItemId: item4.id, name: 'إضافة صوص الجبنة', price: 2.0, category: 'ADDON' },
    ],
  });
  ...
  await prisma.customizationOption.createMany({
    data: [
      ...
      { menuItemId: item5.id, name: 'حجم كبير', price: 2.0, category: 'SIZE' },
